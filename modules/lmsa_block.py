...
from .LargeKernel_Block_CA import LargeKernel_Block



class LMSABlock(BaseModule):
    """
    Args:
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LMSABlock, self).__init__()
        lkb = LargeKernel_Block(in_channels // 2)
        self.local_rep = nn.Sequential(conv_3x3_in, conv_1x1_in, lkb)
